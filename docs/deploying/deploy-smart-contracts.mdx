...
- **🔴 Red**: Contract size exceeds limitations - **DO NOT DEPLOY**. You need to reduce your contract size.

![Contract size exceeds limitations](/img/exceed-limitation.png)

- **🟡 Yellow/🟢 Green**: Contract size is within acceptable limits - **OK to deploy**.

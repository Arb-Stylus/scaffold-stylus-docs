...
Fetch the Ethereum address of the currently connected account using the [useAccount wagmi hook](https://wagmi.sh/react/api/hooks/useAccount) and easily display them using Scaffold Stylus [Address](/components/Address) and [Balance](/components/Balance) components.

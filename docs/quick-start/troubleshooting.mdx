...
- **Check Solidity compiler (`solc`)**: Ensure the Solidity compiler is installed and available in your PATH. Refer to the official guide: https://docs.soliditylang.org/en/latest/installing-solidity.html#
  - macOS (Homebrew):
    ```bash

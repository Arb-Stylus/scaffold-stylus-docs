...
import AddressFull from '/img/AddressFull.png';
import AddressOnlyEnsOrAddress from '/img/AddressOnlyEnsOrAddress.png';
...
<img src={AddressFull} alt="Ens And Address Example" style={{width: '300px', height: 'auto'}} />
...
<img src={AddressOnlyEnsOrAddress} alt="Only Ens Or Address Example" style={{width: '300px', height: 'auto'}} />
